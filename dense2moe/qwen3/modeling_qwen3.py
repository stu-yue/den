...
class Qwen3DecoderLayer(GradientCheckpointingLayer):
    ...
    def forward(
        ...
        **kwargs: Unpack[FlashAttentionKwargs],
        ...
        activation_inputs = hidden_states
        hidden_states = self.mlp(hidden_states)
        hidden_states = residual + hidden_states

        packed_hidden_states = (hidden_states, activation_inputs)

        # outputs = (hidden_states,)
        outputs = (packed_hidden_states,)
...
class Qwen3Model(Qwen3PreTrainedModel):
    ...
    def forward(
        ...
        **flash_attn_kwargs: Unpack[FlashAttentionKwargs],
        ...
        packed_hidden_states = (hidden_states, hidden_states)
        ...
        for decoder_layer in self.layers[: self.config.num_hidden_layers]:
            if output_hidden_states:
                ...
                all_hidden_states += (packed_hidden_states,)
            ...
            hidden_states, activation_inputs = layer_outputs[0]
            packed_hidden_states = (hidden_states, activation_inputs)
